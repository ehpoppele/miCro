--Some attempted tests for the micro language
--Most here do not function, due to their use of features which have been removed
--Other proofs fail since they require assoc and other rules applying to Nats
--But I can't seem to import these since I already have defined Nats
--So I would need to rework micro using import as much as possible for nats and their functions
--Or rewrite assoc and all the other rules myself

module Language.miCro_tests1 where
